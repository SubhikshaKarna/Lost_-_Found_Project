...
<body>
    <div class="container">
        ...
        if (isset($_POST['itemName'])) {
            ...
            // Query to select code and image paths from the database
            $sql = "SELECT * FROM founditem WHERE itemName = '$itemName'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p class='error-message'>No results found for $itemName</p>";
            }
        } else {
            echo "<p class='error-message'>Item Name is not set in the POST data</p>";
        }
